...
import 'package:u_arewa_studio/module/admin/screens/tabs/users/client/add_client.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<dynamic>(
        future: si.userService.getAllUsersByRole('client'),
        builder: ((context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return const Center(
              child: Text('Cannot get all clients'),
            );
          }
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () => si.routerService.nextRoute(context, const AddClient()),
